import { useState, useRef } from 'react';
    ...
    // --- MOCK DATABASE WITH LOCAL DESKTOP FILE PATHS & OCR DATA ---
    const initialClaimsDatabase = {
      'CLM-2026-8891': {
        id: 'CLM-2026-8891',
        policyholder: 'Juan Dela Cruz',
        email: 'juan.delacruz@email.com',
        driverName: 'Jan Dela Cruz', // Mismatch due to bad OCR
        vehicle: '2023 Sedan (ABC 1234)',
        claimType: 'Own Damage',
        claimedAmount: 65000,
        recommendedPayout: 52000, // Deductible applied due to unnamed driver flag
        status: 'In Assessment',
        isFlagged: true,
        category: 'Active',
        flagSummary: '🟡 Unnamed Driver Mismatch, 🔴 Battery Excluded',
        docsCount: 4,
        ocrData: [
          {
            fieldId: 'driver_name',
            label: 'Extracted Driver Name (DL Scan)',
            extractedValue: 'Jan Dela Cruz',
            correctedValue: null,
            confidence: 'Low (62%)',
            isLowConfidence: true,
            sourceDoc: 'doc-2',
            issueNote: 'Image glare caused letter "u" to read as "a". Triggers Unnamed Driver Flag.'
          },
          {
            fieldId: 'license_no',
            label: 'Extracted License Number',
            extractedValue: 'N02-18-998412',
            correctedValue: null,
            confidence: 'High (98%)',
            isLowConfidence: false,
            sourceDoc: 'doc-2',
            issueNote: 'Valid active LTO license.'
          },
          {
            fieldId: 'estimate_total',
            label: 'Parsed Estimate Total',
            extractedValue: '₱65,000.00',
            correctedValue: null,
            confidence: 'High (95%)',
            isLowConfidence: false,
            sourceDoc: 'doc-4',
            issueNote: 'Includes ₱10,000 battery replacement item.'
          }
        ],
        documents: [
          {
            id: 'doc-1',
            title: 'AXA Official Claim Form (Uploaded PDF)',
            type: 'pdf_document',
            fileUrl: 'file:///Users/melissaperez/Desktop/form.pdf',
            fileName: 'form.pdf'
          },
          {
            id: 'doc-2',
            title: 'Philippine Driver License Scan',
            type: 'image_card',
            imageLabel: 'PH Driver License - Juan Dela Cruz',
            caption: 'Republic of the Philippines LTO License Scan | Verified DL Codes: A, A1, B, B1, B2.'
          },
          {
            id: 'doc-3',
            title: 'Vehicle Damage Inspection Photo',
            type: 'image_card',
            imageLabel: 'Impact Damage Photo (Driver Side & Fender)',
            caption: 'Heavy collision damage along left front fender, crushed driver door frame, and shattered windshield glass.'
          },
          {
            id: 'doc-4',
            ...
            type: 'estimate',
            items: [
              { item: '1. Left Front Fender & Door Frame Realignment', cost: 35000, excluded: false },
              { item: '2. Windshield & Glass Replacement', cost: 20000, excluded: false },
              { item: '3. Battery Auxiliary Unit Replacement', cost: 10000, excluded: true }
            ]
          }
        ],
        rules: [
          { type: 'green', title: 'Active Policy Period', text: 'Incident date falls within active coverage (Jan 2026 - Jan 2027).' },
          { type: 'yellow', title: 'Unnamed Driver Surcharge (+₱3,000 Deductible)', text: 'Driver "Jan Dela Cruz" does not match policyholder "Juan Dela Cruz".' },
          { type: 'red', title: 'Excluded Item: Battery Replacement (-₱10,000)', text: 'Section II, Clause 3 excludes routine wear-and-tear electrical parts.' }
        ],
        citation: 'Charter Ping An Master Policy (Page 14): "The Company shall not be liable for electrical failure, routine battery deterioration, or wear and tear unless attributable to a covered accidental collision."'
      },
      'CLM-2026-8892': {
        id: 'CLM-2026-8892',
        policyholder: 'Reign Batac',
        email: 'reign.batac@email.com',
        driverName: 'Reign Batac',
        vehicle: '2021 Honda Civic (XYZ 9876)',
        claimType: 'Own Damage',
        ...
        isFlagged: true,
        category: 'Active',
        flagSummary: '🔴 Expired License & Commercial Use',
        docsCount: 3,
        ocrData: [
          {
            fieldId: 'driver_name',
            label: 'Extracted Driver Name',
            extractedValue: 'Reign Batac',
            correctedValue: null,
            confidence: 'High (96%)',
            isLowConfidence: false,
            sourceDoc: 'doc-1',
            issueNote: 'Name matches policyholder record.'
          },
          {
            fieldId: 'dl_exp_date',
            label: 'Extracted DL Expiry Date',
            extractedValue: '2025-11-14',
            correctedValue: null,
            confidence: 'High (94%)',
            isLowConfidence: false,
            sourceDoc: 'doc-1',
            issueNote: 'License expired prior to incident date.'
          }
        ],
        documents: [
          {
          ...
          {
            id: 'doc-2',
            title: 'Side Door Collision Photo',
            type: 'image_card',
            imageLabel: 'Damage Inspection Photo',
            caption: 'Heavy side door panel impact.'
          },
          {
            id: 'doc-3',
            title: 'Itemized Repair Estimate',
            type: 'estimate',
            items: [
              { item: '1. Left Side Passenger Door Panel', cost: 48000, excluded: false },
              { item: '2. Side Airbag & Sensor Deployment', cost: 50000, excluded: false },
              { item: '3. Front Suspension & Axle Realignment', cost: 30000, excluded: false }
            ]
          }
        ],
        rules: [
          { type: 'red', title: 'Critical Exception: Expired Driver License', text: 'Driver license expired prior to incident date.' },
          { type: 'red', title: 'Commercial Use Violation Detected', text: 'Vehicle registered under Private Car policy but involved in ride-sharing.' }
        ],
        citation: 'AXA Comprehensive Motor Wording (Section IV - Exclusions, Clause 2): "The Company shall not be liable in respect of any accident occurring while the Scheduled Vehicle is being driven by any person who is not fully licensed."'
      },
      'CLM-2026-8893': {
        id: 'CLM-2026-8893',
        ...
        vehicle: '2024 Mitsubishi Montero (NKR 4321)',
        claimType: 'Own Damage',
        claimedAmount: 32000,
        recommendedPayout: 32000,
        status: 'In Assessment',
        isFlagged: false,
        category: 'Active',
        flagSummary: '🟢 Clear (Acts of Nature Active)',
        docsCount: 2,
        ocrData: [
          {
            fieldId: 'driver_name',
            label: 'Extracted Driver Name',
            extractedValue: 'Roberto Tan',
            correctedValue: null,
            confidence: 'High (99%)',
            isLowConfidence: false,
            sourceDoc: 'doc-1',
            issueNote: 'Exact match.'
          }
        ],
        documents: [
          {
          ...
          },
          {
            ...
            type: 'estimate',
            items: [
              { item: '1. Interior Cabin Detailing & Sanitization', cost: 12000, excluded: false },
              { item: '2. Lower ECU / Engine Harness Testing', cost: 20000, excluded: false }
            ]
          }
        ],
        rules: [
          { type: 'green', title: 'Acts of Nature Rider Active', text: 'Policy Schedule includes Endorsement AON-2026 covering flood.' }
        ],
        citation: 'Metrobank / Charter Ping An Acts of Nature Rider (Endorsement AON-1).'
      },
      'CLM-2026-8894': {
        id: 'CLM-2026-8894',
        ...
        vehicle: '2022 Toyota Vios (TUV 5678)',
        claimType: 'Own Damage',
        claimedAmount: 85000,
        recommendedPayout: 0,
        status: 'In Assessment',
        isFlagged: true,
        category: 'Active',
        flagSummary: '🔴 NOT COVERED (No Acts of Nature Cover)',
        docsCount: 3,
        ocrData: [
          {
            fieldId: 'cause_of_loss',
            label: 'Extracted Cause of Loss',
            extractedValue: 'Typhoon Submersion / Water Ingress',
            correctedValue: null,
            confidence: 'High (94%)',
            isLowConfidence: false,
            sourceDoc: 'doc-1',
            issueNote: 'Natural peril event parsed.'
          }
        ],
        documents: [
          {
          ...
          {
            id: 'doc-2',
            title: 'Engine Bay Submersion Photo',
            type: 'image_card',
            imageLabel: 'Flood Submersion Inspection Photo',
            imageUrl: 'file:///Users/melissaperez/Desktop/car.jpg',
            caption: 'Heavy water and mud line marks across entire engine compartment and intake manifold.'
          },
          {
            id: 'doc-3',
            title: 'Itemized Flood Overhaul Estimate',
            type: 'estimate',
            items: [
              { item: '1. Engine Hydro-lock Repair & Cylinder Flush', cost: 55000, excluded: true },
              { item: '2. Dashboard Wiring Harness Replacement', cost: 30000, excluded: true }
            ]
          }
        ],
        rules: [
          { type: 'red', title: 'UNCOVERED CLAIM: Typhoon / Flood Damage Excluded', text: 'Policy is Standard Comprehensive WITHOUT Acts of Nature (AON) Endorsement.' },
          { type: 'red', title: '0% Payout Recommendation', text: 'AI Rule Engine flagged total claim rejection under General Exclusion Sub-clause 5.' }
        ],
        citation: 'AXA Standard Auto Policy Schedule Section V (Perils Excluded): "Loss or damage caused directly or indirectly by flood, typhoon, hurricane, volcanic eruption, earthquake, or other acts of nature is excluded unless specifically endorsed herein."'
      }
    };
